...
def createUsers(baseurl, protocol, accountName, userName, password, apiClient, apiSecret):
    ...
    header = { 
        ...
        "POST": "/controller/restui/userAdministrationUiService/users/create HTTP/1.1",
        "Host": "platform-apacjantrainbp2arp-xwrpidox.srv.ravcloud.com:8090",
        "Connection": "keep-alive",
        "Content-Type": "application/json;charset=UTF-8",
        "Referer": "http://platform-apacjantrainbp2arp-xwrpidox.srv.ravcloud.com:8090/controller/"
        }
    for user in users["users"]:
        print (user)
        
        try:
            r = requests.post(url = createUserURI, data =user, headers = header) 
...
if __name__ == "__main__":
    ...
    jsonfile = "UsersGroupRoles-NFT.json"
    colName = ["name","security_provider_type","displayName","password"]
    createUserurl="/controller/restui/userAdministrationUiService/users/create"
